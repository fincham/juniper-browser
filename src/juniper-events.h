...
void juniper_events_page_load_started(WebKitGtkPage * page, WebKitGtkFrame * frame);
void juniper_events_page_load_finished(WebKitGtkPage * page, WebKitGtkFrame * frame);
void juniper_events_page_link_hover(WebKitGtkPage * page, const gchar * foo, const gchar * url);
